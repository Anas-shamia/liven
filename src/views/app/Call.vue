                ...
                <div class="panel-body mb-4">
                    <div class="">
                        <div class="flex items-center flex-wrap mb-4">
                            <label class="w-1/4 text-base text-blue-800 rtl:pl-8 ltr:pr-8">رقم الاتصال</label>
                            <input id="appId"
                                   class="w-3/4 bg-white-900 rounded-25px py-3 px-6 focus:outline-none border border-transparent"
                                   type="text" value="" size="36">
                        </div>
                        <div class="flex items-center flex-wrap mb-4">
                            <label class="w-1/4 text-base text-blue-800 rtl:pl-8 ltr:pr-8">القناة</label>
                            <input id="channel"
                                   class="w-3/4 bg-white-900 rounded-25px py-3 px-6 focus:outline-none border border-transparent"
                                   type="text" value="1000" size="4">
                        </div>
