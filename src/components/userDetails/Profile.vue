<template>
    <div class="bg-white-900 px-3 py-10 rounded-lg mb-6 3sm:mb-4 3sm:py-5">
        <div class="mx-auto text-center mb-8 3sm:mb-4">
            <img class="object-cover w-24 h-24 rounded-full mx-auto mb-6" v-if="this.image" :src="this.image"
                 alt="profile-pic">
            <img class="object-cover w-24 h-24 rounded-full mx-auto mb-6" v-else src="@/assets/img/avatar.svg"
                 alt="profile-pic">
            <h3 class="font-semibold text-gray-600 text-2xl 4xl:text-lg">{{this.name}}</h3>
        </div>
        <div>
            ...
            <ul class="pb-6 3sm:pb-4">
                <li class="flex items-center px-4 py-6 3sm:px-2 3sm:py-4 border-b border-gray-800">
                    ...
                    <p class="text-gray-400 font-medium text-base 4xl:text-sm">{{this.length}}<span
                ...
                <li class="flex items-center px-4 py-6 3sm:px-2 3sm:py-4 border-b border-gray-800">
                    ...
                    <p class="text-gray-400 font-medium text-base 4xl:text-sm">{{this.weight}}<span
                ...
                <li class="flex items-center px-4 py-6 3sm:px-2 3sm:py-4 border-b border-gray-800">
                    ...
                    <p class="text-gray-400 font-medium text-base 4xl:text-sm">{{this.age}}</p>
                </li>
                <li class="flex items-center px-4 py-6 3sm:px-2 3sm:py-4 border-b border-gray-800">
                    ...
                    <p class="text-gray-400 font-medium text-base 4xl:text-sm">{{this.gender}}</p>
                </li>
            </ul>
            <button type="button"
...
<script>
    export default {
        props:['image','name','length','weight','age','gender'],
        methods:{
            openCalls() {
